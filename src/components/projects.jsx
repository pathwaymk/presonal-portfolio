    ...
    const projectData = [
        {
            ...
            link : "https://github.com/pathwaymk/Coindcx"
        },
        {
            ...
            link : "https://github.com/pathwaymk/movie"
        }
    ]
    ...
    const projects = projectData.map((data) => {
        return(
            <div className={isLight ? "project shadow" : "project shadow sback"}>
                ...
                <div>
                    <span style={{display : "inline"}}>Github link : </span>
                    <a href={data.link} className="project" style={{display : "inline"}}>{data.title}</a>
                </div>
            </div>
        )
    })
